...
function Sidebar() {
  ...
  // Leer usuario real de localStorage
      ...
      <div style={{ flex: 1, marginLeft: 224, display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
        ...
        <main style={{ flex: 1, padding: '26px 28px' }}>
          <Routes>
            ...
            <Route path="/candidatos/registrar" element={<ProtectedRoute><CandidatoForm /></ProtectedRoute>} />  {/* ← PRIMERO */}
            <Route path="/candidatos" element={<ProtectedRoute><CandidatosList /></ProtectedRoute>} />  {/* ← DESPUÉS */}
          </Routes>
        </main>
      </div>
    </div>
    ...
    <ThemeContext.Provider value={{ dark, toggle: () => setDark(d => !d), t }}>
      <BrowserRouter>
        ...
        <Routes>
          ...
          {/* Todo lo demás va dentro del Layout con sidebar */}
