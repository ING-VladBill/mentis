...
public final class DaggerMentisApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends MentisApplication_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(MapBuilder.<String, Boolean>newMapBuilder(2).put(LazyClassKeyProvider.com_mentis_app_presentation_acceso_AccesoViewModel, AccesoViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_mentis_app_presentation_progreso_ProgresoViewModel, ProgresoViewModel_HiltModules.KeyModule.provide()).build());
    }
  ...
  private static final class ViewModelCImpl extends MentisApplication_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.progresoViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 1);
    }

    @Override
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(MapBuilder.<String, javax.inject.Provider<ViewModel>>newMapBuilder(2).put(LazyClassKeyProvider.com_mentis_app_presentation_acceso_AccesoViewModel, ((Provider) accesoViewModelProvider)).put(LazyClassKeyProvider.com_mentis_app_presentation_progreso_ProgresoViewModel, ((Provider) progresoViewModelProvider)).build());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 1: // com.mentis.app.presentation.progreso.ProgresoViewModel 
  ...
  private static final class SingletonCImpl extends MentisApplication_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.progresoRepositoryImplProvider = new SwitchingProvider<>(singletonCImpl, 6);
      this.bindProgresoRepositoryProvider = DoubleCheck.provider((Provider) progresoRepositoryImplProvider);
    }

    @Override
    public void injectMentisApplication(MentisApplication arg0) {
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 6: // com.mentis.app.data.repository.ProgresoRepositoryImpl 
